...
if ($GLOBALS['TL_CONFIG']['useRTE']):
	...
	<script>
		window.tinymce && tinymce.init({
			...
			menubar: false,
			toolbar1: "link image pastetext table charmap | undo redo cut copy paste removeformat | code visualblocks searchreplace fullscreen textcolor | subscript superscript underline strikethrough",
			toolbar2: "styleselect formatselect fontselect fontsizeselect bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent",
